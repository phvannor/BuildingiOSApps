...
- (void)viewDidLoad
{
    ...
    // TODO: Comment out default load if using authentication
    [self refresh];
}
...
#pragma mark - Simple Authentication Example Snippet

/*

// Note: remove [self refresh] from viewDidLoad when enabling this
...
-(void) login
{
    UINavigationController *controller = (UINavigationController *)
        [self.todoService.client loginViewControllerWithProvider:@"twitter"
